...
class EditSiteParser:
    ...
    def edit_site_parser():
        ...
        edit_site_parser = subparsers.add_parser('editsite',
                                                 parents=[parser])
        edit_site_parser.add_argument('--site-name', default=None,
                                      help='name of site')
        ...
        edit_site_parser.add_argument('--extract-encryption-mode', default=None,
                                      help='The extract encryption mode for '
                                           ...
                                           'enabled or disabled')
        edit_site_parser.add_argument('--run-now-enabled', default=None,
                                      help='Allow or deny users from running '
                                           'extract refreshes, flows, or '
                                           'schedules manually.')
        edit_site_parser.add_argument('--storage-quota', type=int,
                                      default=None,
