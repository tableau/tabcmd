...
#     import mock
# import argparse
# from ..pythontabcmd2.parsers import delete_users_parser
# create_user_command_class = delete_users_parser.DeleteUserParser
#
#
# class DeleteUserParserTest(unittest.TestCase):
