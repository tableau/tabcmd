...
def set_role_arg(parser):
    parser.add_argument(
        '-r', '--role',
        choices=['ServerAdministrator', 'SiteAdministratorCreator', 'SiteAdministratorExplorer', 'SiteAdministrator',
                 'Creator', 'ExplorerCanPublish', 'Publisher', 'Explorer', 'Interactor', 'Viewer', 'Unlicensed'],
...
def set_site_args(parser):
    ...
    parser.add_argument(
        '--extract-encryption-mode', choices=['enforced', 'enabled', 'disabled'],
...
def set_publish_args(parser):
    ...
    parser.add_argument('--encrypt-extracts',
...
def set_update_group_args(parser):
    parser.add_argument(
        '--grant-license-mode', choices=['on-login', 'on-sync'],
        help='Specifies whether a role should be granted on sign in. ')
    parser.add_argument(
        '--overwritesiterole', action='store_true',
...
def set_validate_idp_options(parser):
    parser.add_argument(
        '--digest-algorithms', metavar="<ALGORITHMS>",
