...
class CreateSiteParser:
    ...
    def create_site_parser():
        ...
        create_site_parser = subparsers.add_parser('createsite', parents=[parser])
        create_site_parser.add_argument('--site-name', default=None, help='name of site')
        ...
        args = create_site_parser.parse_args(sys.argv[CreateSiteParser.USER_ARG_IDX:])
